...
Quickly onboard large groups with CSV import supporting up to 8,000 members at once. Perfect for established communities migrating to Homeschool Hive or groups with existing member lists.
...
### Authentication
- Fixed an issue causing some users to be logged out after one hour
