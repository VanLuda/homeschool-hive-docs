...
description: Event series for recurring activities, custom roles with 14 granular permissions, and bulk member import.
authors: [famlo]
...
Quickly onboard large groups with CSV import supporting up to thousands of members at once. Perfect for established communities migrating to Famlo or groups with existing member lists.
