...
description: Learn how to manage your saved payment methods for memberships and event registrations.
---
...
1. **[View payment history](/docs/parents/payments)** - See all your transactions
2. **[Manage subscriptions](/docs/parents/group-membership)** - Control membership billing
