...
description: Learn how to add and manage family members, children, and their information.
---
...
1. **[Manage payment methods](/docs/account/payment-methods)** - Set up payment cards
2. **[Find events](/docs/parents/find-events)** - Browse activities for your family
3. **[Update notifications](/docs/getting-started/notifications)** - Control alerts
