...
1. **[Manage family members](/docs/account/family-members)** - Add children and family info
2. **[Update payment methods](/docs/account/payment-methods)** - Manage saved cards
3. **[Set notifications](/docs/getting-started/notifications)** - Configure alerts
