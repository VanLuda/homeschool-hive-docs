...
description: Add children and adults, and record allergies, medications, and pickup.
---
<!-- SOURCE: docs/account/family-members.md -->
# Family Members
...
1. **[Manage payment methods](/docs/families/payments-and-refunds)** - Set up payment cards
2. **[Find events](/docs/families/finding-activities)** - Browse activities for your family
3. **[Update notifications](/docs/account/notifications)** - Control alerts
