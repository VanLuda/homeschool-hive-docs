...
---
<!-- SOURCE: docs/group-leaders/membership-fees.md -->
# Membership Fees
...
1. **[Manage members](/docs/organizations/members-and-roles)** - Handle member requests and roles
2. **[Generate scholarship invoices](/docs/organizations/scholarships)** - For scholarship families
3. **[View analytics](/docs/organizations/insights)** - Track group performance
