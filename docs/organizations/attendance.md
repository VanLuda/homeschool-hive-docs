...
---
<!-- SOURCE: docs/group-leaders/check-in.md -->
# Check-In & Attendance
...
- **[Event Series](/docs/organizations/activities)** - Learn about managing recurring events
- **[Analytics](/docs/organizations/insights)** - Use attendance data for insights and planning
- **[Manage Events](/docs/organizations/activities)** - Additional event management features
