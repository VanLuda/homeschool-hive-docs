...
---
<!-- SOURCE: docs/group-leaders/group-settings.md -->
...
For a detailed walkthrough, see [Stripe Connect Setup](/docs/organizations/getting-paid).
...
For the full guide, see [Discount Codes](/docs/organizations/promo-codes).
...
For step-by-step instructions, see [Custom Roles & Permissions](/docs/organizations/members-and-roles).
...
For more details, see [Scholarship Invoices](/docs/organizations/scholarships).
...
- [Creating a Group](/docs/organizations/listing-your-organization)
- [Stripe Connect Setup](/docs/organizations/getting-paid)
- [Custom Roles & Permissions](/docs/organizations/members-and-roles)
- [Discount Codes](/docs/organizations/promo-codes)
- [Scholarship Invoices](/docs/organizations/scholarships)
- [Membership Fees](/docs/organizations/membership-dues)
- [Deleting a Group](/docs/organizations/closing-your-listing)
