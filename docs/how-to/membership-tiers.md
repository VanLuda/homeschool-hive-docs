...
**What happens to existing members when I switch to paid?**
Existing free members remain free. Only new members joining after the change pay the membership fee.

**Can members pay for multiple years at once?**
Currently, members pay one billing cycle at a time. Annual billing is the longest single payment period available.

**How do I offer family memberships?**
...
**Do members get charged at midnight?**
Stripe processes recurring payments throughout the day of renewal. Members are charged on the anniversary of their join date.

## Related Articles

- [Stripe Payment Setup](/docs/group-leaders/payments-stripe) - Detailed Stripe configuration
- [Managing Members](/docs/group-leaders/manage-members) - Member administration
- [Group Settings](/docs/group-leaders/create-group) - Other group configuration options
- [Membership Fees Overview](/docs/group-leaders/membership-fees) - Complete membership guide
