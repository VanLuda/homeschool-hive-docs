...
**Group Name:**
Choose a clear, descriptive name that helps families understand your focus.
...
1. Start typing your city or address
...
**Paid Membership:**
Configure pricing for your group:

1. Set your membership fee amount
2. Choose a billing cycle:
   - **Monthly** - Recurring payment each month
   - **Annual** - One payment per year (often a better value)
3. Optionally set grace periods for payment lapses
...
4. Add additional questions as needed
...
2. Follow the Stripe onboarding process
...
1. Review all your settings on the summary page
2. Make any final adjustments
3. Click **Create Group**
4. Your group is now live!
...
3. Share via email, social media, or local homeschool networks
...
3. Set up an inaugural event or regular meeting
4. Members will receive notifications
...
2. Assign Co-Leader or Event Manager roles
