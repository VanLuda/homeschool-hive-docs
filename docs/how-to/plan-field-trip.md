...
**Event Type:**
Select **In-Person Event** for field trips.
...
**Set Capacity Limits:**
Most venues have maximum group sizes. Configure limits to stay within requirements:
...
**Enable Waitlist:**
Allow families to join a waitlist if the trip fills up:
...
**For Paid Field Trips:**
Create ticket types that match your pricing structure:
...
|-------------|-------|-------------|
| Adult | $15 | Ages 13 and up |
| Child (5-12) | $10 | Ages 5-12 |
| Child (under 5) | Free | Ages 4 and under |
...
Add field-trip-specific questions:
