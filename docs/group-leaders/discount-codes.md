...
- **[Tickets & Pricing](/docs/group-leaders/tickets-pricing)** - Configure event tickets and add-ons
- **[Scholarship Invoices](/docs/group-leaders/scholarship-invoices)** - Generate invoices for scholarship families
- **[Stripe Payments](/docs/group-leaders/payments-stripe)** - Set up your payment account
- **[Membership Fees](/docs/group-leaders/membership-fees)** - Configure group membership billing
