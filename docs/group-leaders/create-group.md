...
3. See [Creating Events](/docs/group-leaders/create-events) for details
...
1. **[Manage members](/docs/group-leaders/manage-members)** - Approve requests and manage roles
2. **[Create events](/docs/group-leaders/create-events)** - Organize activities for your group
3. **[Set up payments](/docs/group-leaders/payments-stripe)** - Configure Stripe for paid features
