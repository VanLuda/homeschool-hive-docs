...
sidebar_position: 6
title: Event Series
description: Learn how to create recurring events with series passes and drop-in options for your homeschool group.
---
...
For detailed check-in instructions, see [Check-In & Attendance](/docs/group-leaders/check-in).
...
1. **[Check-In & Attendance](/docs/group-leaders/check-in)** - Track attendance at your series sessions
2. **[Tickets & Pricing](/docs/group-leaders/tickets-pricing)** - Advanced ticketing options
3. **[Send Announcements](/docs/group-leaders/announcements)** - Keep series attendees informed
