...
sidebar_position: 10
title: Watchlist
description: Save events to your watchlist to track availability, get capacity alerts, and stay organized.
---
...
:::info
You must be logged in to use the watchlist. If you try to access it without signing in, you will be redirected to the login page.
:::
...
:::tip
Adding an event to your watchlist does not register you for it. To attend, you still need to RSVP or complete checkout separately. See [RSVP for Events](/docs/parents/rsvp-events) for details.
:::
...
| Indicator | Meaning |
|---|---|
| No badge | The event has plenty of available spots. |
...
| Faded appearance | The event has already taken place. |
...
:::tip
For high-demand events, add them to your watchlist as soon as you see them -- even if they are not full yet. That way, you will receive a notification if the event reaches capacity and then a spot opens up later.
:::
...
| Feature | Purpose |
|---|---|
| **Watchlist** | Track specific events you have already found and want to monitor. |
| **[Location Alerts](/docs/parents/location-alerts)** | Get notified when brand-new groups or events are created in a specific area. |
...
- [Find Events](/docs/parents/find-events) -- discovering events to add to your watchlist
- [RSVP for Events](/docs/parents/rsvp-events) -- registering for events
- [Location Alerts](/docs/parents/location-alerts) -- monitoring areas for new content
- [Calendar](/docs/parents/calendar) -- viewing your registered events on a calendar
