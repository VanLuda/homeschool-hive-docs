...
description: Step-by-step guide to the event checkout process, including ticket selection, attendees, add-ons, discounts, and payment.
---
...
If the tickets you want are no longer available, add the event to your [Watchlist](/docs/parents/watchlist) to be notified if spots open up.

## Related Documentation

- [RSVP for Events](/docs/parents/rsvp-events) -- overview of the RSVP process
