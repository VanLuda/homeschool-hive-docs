...
Configure notification preferences in your [notification settings](/docs/getting-started/notifications).
...
1. **[Find more events](/docs/parents/find-events)** - Discover new activities
2. **[RSVP for events](/docs/parents/rsvp-events)** - Register for upcoming events
3. **[Manage notifications](/docs/getting-started/notifications)** - Set up event reminders
