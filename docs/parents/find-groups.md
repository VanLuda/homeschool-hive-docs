...
sidebar_position: 1
title: Find Groups
description: Learn how to discover and explore homeschool groups in your area.
---
...
1. **[Join a group](/docs/parents/group-membership)** - Request membership or complete payment
2. **[Find events](/docs/parents/find-events)** - Browse activities from groups you've joined
3. **[RSVP for events](/docs/parents/rsvp-events)** - Register your family for activities
