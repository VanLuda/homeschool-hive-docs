...
1. **[Complete your profile](/docs/getting-started/complete-profile)** - Add your family information
2. **[Set up notifications](/docs/getting-started/notifications)** - Choose how you want to be notified
3. **[Find groups to join](/docs/parents/find-groups)** - Discover homeschool groups in your area
