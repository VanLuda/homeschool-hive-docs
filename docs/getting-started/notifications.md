...
1. **[Find groups to join](/docs/parents/find-groups)** - Discover homeschool groups in your area
2. **[Browse events](/docs/parents/find-events)** - See what activities are happening
3. **[Learn about RSVPs](/docs/parents/rsvp-events)** - Understand how to register for events
