...
1. **[Set up your notification preferences](/docs/getting-started/notifications)** - Choose how you want to receive updates
2. **[Find groups in your area](/docs/parents/find-groups)** - Start discovering homeschool groups
3. **[Browse upcoming events](/docs/parents/find-events)** - See what activities are available
